...
const { createProduct, getProducts, getProductById, deleteProduct, updateProduct, getFeaturedProducts, searchProducts } = require('../controllers/productController.js');
